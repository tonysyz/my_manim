...
class Functions(GraphScene):
    ...
    def construct(self):
        ...
        fun_1_lim1 = TexMobject(r'\lim\limits_{x\to-\infty}xe^x=0').to_edge(UP)
        fun_1_lim2 = TexMobject(r'\lim\limits_{x\to -1}xe^x=-\frac{1}{e}').next_to(fun_1_lim1,DOWN)
        fun_1_lim3 = TexMobject(r'\lim\limits_{x\to0}xe^x=0').next_to(fun_1_lim2,DOWN)
        fun_1_lim4 = TexMobject(r'\lim\limits_{x\to1}xe^x=e').next_to(fun_1_lim3,DOWN)
        fun_1_lim5 = TexMobject(r'\lim\limits_{x\to+\infty}xe^x=+\infty').next_to(fun_1_lim4,DOWN)
        self.play(
            Write(fun_1_lim1),Write(fun_1_lim2),Write(fun_1_lim3),Write(fun_1_lim4),Write(fun_1_lim5)
        )
        self.wait(7)
        group1 = VGroup(fun_1_lim1,fun_1_lim2,fun_1_lim3,fun_1_lim4,fun_1_lim5)
        self.play(FadeOut(group1))
        ...
        self.wait()
        der_2_1 = self.get_graph(lambda x: (x-1)*(self.e**x)/(x**2),x_min=0.2,color=GREEN)
        der_2_2 = self.get_graph(lambda x: (x-1)*(self.e**x)/(x**2),x_max=-0.2,color=GREEN)
        ...
        self.play(FadeOut(self.axes))
        self.play(FadeOut(plane))
        lim2_1 = TexMobject(r'\lim\limits_{x\to-\infty}{e^x \over x}=0').to_edge(UP)
        lim2_2 = TexMobject(r'\lim\limits_{x\to-1}{e^x \over x}=-{1 \over e}').next_to(lim2_1,DOWN)
        lim2_3 = TexMobject(r'\lim\limits_{x\to 0}{e^x \over x}=\infty').next_to(lim2_2,DOWN)
        lim2_4 = TexMobject(r'\lim\limits_{x\to 1}{e^x \over x}=e').next_to(lim2_3,DOWN)
        lim2_5 = TexMobject(r'\lim\limits_{x\to +\infty}{e^x \over x}=+\infty').next_to(lim2_4,DOWN)
        self.play(
            Write(lim2_1),Write(lim2_2),Write(lim2_3),Write(lim2_4),Write(lim2_5)
        )
        self.wait(6)
        self.play(
            FadeOut(lim2_1),FadeOut(lim2_2),FadeOut(lim2_3),FadeOut(lim2_4),FadeOut(lim2_5)
        )
        ...
        self.play(FadeOut(self.axes))
        self.play(FadeOut(plane))
        lim3_1 = TexMobject(r'\lim\limits_{x\to-\infty}{x \over e^x}=-\infty').to_edge(UP)
        lim3_2 = TexMobject(r'\lim\limits_{x\to-1}{x \over e^x}=-e').next_to(lim3_1,DOWN)
        lim3_3 = TexMobject(r'\lim\limits_{x\to 0}{x \over e^x}=0').next_to(lim3_2,DOWN)
        lim3_4 = TexMobject(r'\lim\limits_{x\to 1}{x \over e^x}={1\over e}').next_to(lim3_3,DOWN)
        lim3_5 = TexMobject(r'\lim\limits_{x\to +\infty}{x \over e^x}=0').next_to(lim3_4,DOWN)
        self.play(
            Write(lim3_1),Write(lim3_2),Write(lim3_3),Write(lim3_4),Write(lim3_5)
        )
        self.wait(6)
        self.play(
            FadeOut(lim3_1),FadeOut(lim3_2),FadeOut(lim3_3),FadeOut(lim3_4),FadeOut(lim3_5)
        )
        ...
        func4_label = self.get_graph_label(func4,label='y=x \\ln x').shift(DOWN*2)
        ...
        self.play(FadeOut(self.axes))
        self.play(FadeOut(plane))
        lim4_1 = TexMobject(r'\lim\limits_{x\to0 }{x\ln x}=0').to_edge(UP)
        lim4_2 = TexMobject(r'\lim\limits_{x\to{1\over e}}}{x\ln x}=-{1\over e}').next_to(lim4_1,DOWN)
        lim4_3 = TexMobject(r'\lim\limits_{x\to 1}{x\ln x}=0').next_to(lim4_2,DOWN)
        lim4_4 = TexMobject(r'\lim\limits_{x\to e}{x\ln x}=e').next_to(lim4_3,DOWN)
        lim4_5 = TexMobject(r'\lim\limits_{x\to +\infty}{x\ln x}=+\infty').next_to(lim4_4,DOWN)
        self.play(
            Write(lim4_1),Write(lim4_2),Write(lim4_3),Write(lim4_4),Write(lim4_5)
        )
        self.wait(6)
        self.play(
            FadeOut(lim4_1),FadeOut(lim4_2),FadeOut(lim4_3),FadeOut(lim4_4),FadeOut(lim4_5)
        )
        ...
        self.play(FadeOut(self.axes))
        self.play(FadeOut(plane))
        lim5_1 = TexMobject(r'\lim\limits_{x\to 0}{{\ln x} \over {x}}=-\infty').to_edge(UP)
        lim5_2 = TexMobject(r'\lim\limits_{x\to{1\over e}}}{{\ln x} \over {x}}=-e').next_to(lim5_1,DOWN)
        lim5_3 = TexMobject(r'\lim\limits_{x\to 1}{{\ln x} \over {x}}=0').next_to(lim5_2,DOWN)
        lim5_4 = TexMobject(r'\lim\limits_{x\to e}{{\ln x} \over {x}}={1\over e}').next_to(lim5_3,DOWN)
        lim5_5 = TexMobject(r'\lim\limits_{x\to +\infty}{{\ln x} \over {x}}=0').next_to(lim5_4,DOWN)
        self.play(
            Write(lim5_1),Write(lim5_2),Write(lim5_3),Write(lim5_4),Write(lim5_5)
        )
        self.wait(6)
        self.play(
            FadeOut(lim5_1),FadeOut(lim5_2),FadeOut(lim5_3),FadeOut(lim5_4),FadeOut(lim5_5)
        )
        ...
        self.play(FadeOut(self.axes))
        self.play(FadeOut(plane))
        lim6_1 = TexMobject(r'\lim\limits_{x\to 0}{{x} \over {\ln x}}=0').to_edge(UP)
        lim6_2 = TexMobject(r'\lim\limits_{x\to{1\over e}}}{{x} \over {\ln x}}=-{1\over e}').next_to(lim6_1,DOWN)
        lim6_3 = TexMobject(r'\lim\limits_{x\to 1}{{x} \over {\ln x}}=\infty').next_to(lim6_2,DOWN)
        lim6_4 = TexMobject(r'\lim\limits_{x\to e}{{x} \over {\ln x}}=e').next_to(lim6_3,DOWN)
        lim6_5 = TexMobject(r'\lim\limits_{x\to +\infty}{{x} \over {\ln x}}=+\infty').next_to(lim6_4,DOWN)
        self.play(
            Write(lim6_1),Write(lim6_2),Write(lim6_3),Write(lim6_4),Write(lim6_5)
        )
        self.wait(6)
        self.play(
            FadeOut(lim6_1),FadeOut(lim6_2),FadeOut(lim6_3),FadeOut(lim6_4),FadeOut(lim6_5)
        )
        tabel = TextMobject(
            r"\begin{table}[]"
            r"\begin{tabular}{|l|l|l|l|l|l|l|l|l|}"
            r"\cline{1-4} \cline{6-9}"
            r" & $xe^x$ & ${{e^x}\over x}$ & ${{x} \over {e^x}}$ &  & $x \ln x$ & ${{\ln x}\over {x}}$ & ${{x}\over{\ln x}}$ &  \\ \cline{1-4} \cline{6-9}"
            r"$\lim\limits_{x\to-\infty}$ & 0 & 0 & $-\infty$ &  & 0 & $-\infty$ & 0 & $\lim\limits_{x\to0 }$ \\ \cline{1-4} \cline{6-9}"
            r"$\lim\limits_{x\to-1}$ & $-\frac{1}{e}$ & $-{1 \over e}$ & $-e$ &  & $-{1\over e}$ & $-e$ & $-{1\over e}$ & $\lim\limits_{x\to{1\over e}}$ \\ \cline{1-4} \cline{6-9}"
            r"$\lim\limits_{x\to 0}$ & $0$ & $\infty$ & 0 &  & 0 & 0 & $\infty$ & $\lim\limits_{x\to 1}$ \\ \cline{1-4} \cline{6-9}"
            r"$\lim\limits_{x\to 1}$ & $e$ & $e$ & ${1\over e}$ &  & $e$ & ${1\over e}$ & $e$ & $\lim\limits_{x\to e}$ \\ \cline{1-4} \cline{6-9}"
            r"$\lim\limits_{x\to +\infty}$ & $+\infty$ & $+\infty$ & 0 &  & $+\infty$ & 0 & $+\infty$ & $\lim\limits_{x\to +\infty}$ \\ \cline{1-4} \cline{6-9}"
            r"\end{tabular}"
            r"\end{table}"
        )
        #func1 = self.get_graph(lambda x: x*(self.e**x),color=GREEN)
        ...
        self.play(ShowCreation(tabel),run_time=2)
        e = math.e
        r1 = Rectangle(color=BLUE,height=5,width=1.5).move_to(np.array([-4.3,0,0]))
        self.play(ShowCreation(r1))
        r2 = Rectangle(color=BLUE,height=5,width=1.8).move_to(np.array([1.1,0,0]))
        self.play(ShowCreation(r2))
        self.wait()
        self.play(
            FadeOut(r2),FadeOut(tabel),FadeOut(r1)
        )
        self.wait()
        self.setup_axes(animate=True)
        plane = NumberPlane()
        dot1 = Dot().move_to(np.array([1,e,0]))
        dot2 = Dot().move_to(np.array([e,e,0]))
        dot3 = Dot().move_to(np.array([-1,-1/e,0]))
        dot4 = Dot().move_to(np.array([1/e,-1/e,0]))
        dot5 = Dot()
        dot6 = Dot().move_to(np.array([1,0,0]))
        self.play(ShowCreation(plane))
        self.play(
            ShowCreation(func1),ShowCreation(func1_label)
        )
        self.play(
            ShowCreation(dot1),ShowCreation(dot3),ShowCreation(dot5)
        )
        self.play(
            Transform(func1,func4),Transform(dot1,dot2),Transform(dot3,dot4),Transform(dot5,dot6),Transform(func1_label,func4_label),run_time=3
        )
        self.wait(3)
        g1 = VGroup(self.axes,plane,func4,func4_label,dot6,dot5,dot4,dot3,dot2,dot1,func1,func1_label)
        self.play(FadeOut(g1))


        
        self.play(ShowCreation(tabel),run_time=2)
        r3 = Rectangle(color=RED,height=5,width=1.5).move_to(np.array([-2.8,0,0]))
        r4 = Rectangle(color=RED,height=5,width=1.5).move_to(np.array([4.3,0,0]))
        self.play(
            ShowCreation(r3),ShowCreation(r4)
        )
        self.wait()
        self.play(
            FadeOut(r3),FadeOut(tabel),FadeOut(r4)
        )
        plane = NumberPlane()
        dot1 = Dot().move_to(np.array([-1,-1/e,0]))
        dot2 = Dot().move_to(np.array([1/e,-1/e,0]))
        dot3 = Dot().move_to(np.array([1,e,0]))
        dot4 = Dot().move_to(np.array([e,e,0]))
        self.play(ShowCreation(plane))
        self.play(
            ShowCreation(func2),ShowCreation(func2_label)
        )
        self.play(
            ShowCreation(dot1),ShowCreation(dot3)
        )
        self.play(
            Transform(func2,func6),Transform(dot1,dot2),Transform(dot3,dot4),Transform(func2_label,func6_label),run_time=3
        )
        self.wait(3)
        g2 = VGroup(self.axes,plane,func6,func6_label,dot4,dot3,dot2,dot1,func2,func2_label)
        self.play(FadeOut(g2))


        self.play(ShowCreation(tabel))
        r5 = Rectangle(color=GREEN,height=5,width=1.5).move_to(np.array([-1.25,0,0]))
        r6 = Rectangle(color=GREEN,height=5,width=1.5).move_to(np.array([2.8,0,0]))
        self.play(
            ShowCreation(r5),ShowCreation(r6)
        )
        self.wait()
        self.play(
            FadeOut(r5),FadeOut(tabel),FadeOut(r6)
        )
        self.setup_axes(animate=True)
        plane = NumberPlane()
        dot1 = Dot().move_to(np.array([-1,-e,0]))
        dot2 = Dot().move_to(np.array([1/e,-e,0]))
        dot3 = Dot().move_to(np.array([0,0,0]))
        dot4 = Dot().move_to(np.array([1,0,0]))
        dot5 = Dot().move_to(np.array([1,1/e,0]))
        dot6 = Dot().move_to(np.array([e,1/e,0]))
        self.play(ShowCreation(plane))
        self.play(
            ShowCreation(func3),ShowCreation(func3_label)
        )
        self.play(
            ShowCreation(dot1),ShowCreation(dot3),ShowCreation(dot5)
        )
        self.play(
            Transform(func3,func5),Transform(dot1,dot2),Transform(dot3,dot4),Transform(dot5,dot6),Transform(func3_label,func5_label),run_time=3
        )
        self.wait(3)
        g3 = VGroup(self.axes,plane,func5,func3,func3_label,func5_label,dot6,dot5,dot4,dot3,dot2,dot1)
        self.play(FadeOut(g3))

        end = TextMobject(r'Thanks For Watching.').move_to(np.array([0,2,0]))
        end_ = TextMobject(r'tools:manim, Adobe Premiere Pro CC 2019 \\music:Bruno Wen-li - ヨスガノソラ メインテーマ -願い-\\by emat').next_to(end,DOWN)
        self.play(
            ShowCreation(end),Write(end_)
        )
